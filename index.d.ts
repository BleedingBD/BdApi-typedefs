...
/**
 * Function with no arguments and no return value that may be called to revert changes made by the `Patcher` or the `monkeyPatch` method, restoring (unpatching) original method.
 */
...
export type PatcherBeforeCallback = (this: object, params: any[]) => any;
export type PatcherAfterCallback = (this: object, params: any[], returnValue: any) => any;
export type PatcherInsteadCallback = (this: object, params: any[], originalMethod: Function) => any;
